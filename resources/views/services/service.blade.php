      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-2">
            ...
            <a href="user/login"><img style="height:100px; width:100px;" src="{{ asset('icon/studentpanel.png') }}"></a>
              <div class="service-content">
                <h2 class="s-title">Student</h2>
              </div>
            </div>
          </div>
          <div class="col-md-2">
            <div class="service-box">
            <a href="teacher/login"><img style="height:100px; width:100px;" src="{{ asset('icon/teacherpanel.png') }}"></a>
              <div class="service-content">
